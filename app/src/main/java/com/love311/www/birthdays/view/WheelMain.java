package com.love311.www.birthdays.view;
...
import com.love311.www.birthdays.utils.OtherUtil;
...
public class WheelMain {
	...
	public void showlunarTimePicker() {
		...
		final String year[] = OtherUtil.getYera();
		...
		wv_year.setLabel("");
		wv_year.setAdapter(new ArrayWheelAdapter<String>(year, 20));// 设置"年"的显示数据
	...
	public void setTime(final int year, final int month, final int day) {
		...
		btn_solar.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				btn_solar.setTextColor(Color.WHITE);
				btn_lunar.setBackgroundResource(R.drawable.whtbtn);
				btn_lunar.setTextColor(Color.parseColor("#fff94627"));
		...
		btn_lunar.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				btn_lunar.setTextColor(Color.WHITE);
				btn_solar.setBackgroundResource(R.drawable.whtbtn);
				btn_solar.setTextColor(Color.parseColor("#fff94627"));
				showlunarTimePicker();
			}
